 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CaseMarker implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CaseMarker';
    ...
    public function setValueStr($value_str)
    {
        if (!is_null($value_str) && (mb_strlen($value_str) > 250)) {
            throw new \InvalidArgumentException('invalid length for $value_str when calling CaseMarker., must be smaller than or equal to 250.');
        }
    ...
    public function setValueInt($value_int)
    {
        ...
        if (!is_null($value_int) && ($value_int > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $value_int when calling CaseMarker., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($value_int) && ($value_int < -2147483648)) {
            throw new \InvalidArgumentException('invalid value for $value_int when calling CaseMarker., must be bigger than or equal to -2147483648.');
        }
     ...
     * Sets start
     *
     * @param int $start Start position of marker (from 0)
     *
     * @return $this
     */
    public function setStart($start)
    {
        ...
        if (!is_null($start) && ($start > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $start when calling CaseMarker., must be smaller than or equal to 4294967295.');
        }
        if (!is_null($start) && ($start < 0)) {
            throw new \InvalidArgumentException('invalid value for $start when calling CaseMarker., must be bigger than or equal to 0.');
        }
     ...
     * Sets end
     *
     * @param int $end End position of marker
     *
     * @return $this
     */
    public function setEnd($end)
    {
        ...
        if (!is_null($end) && ($end > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $end when calling CaseMarker., must be smaller than or equal to 4294967295.');
        }
        if (!is_null($end) && ($end < 0)) {
            throw new \InvalidArgumentException('invalid value for $end when calling CaseMarker., must be bigger than or equal to 0.');
        }
